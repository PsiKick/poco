...
namespace
{
		...
		/// Convert field MySQL-type and field MySQL-length to actual field length
	{
		...
		default:
			throw Poco::SQL::MySQL::StatementException("unknown field type");
		}
	}	

	Poco::SQL::MetaColumn::ColumnDataType fieldType(const MYSQL_FIELD& field)
		/// Convert field MySQL-type to Poco-type	
	{
		...
		case MYSQL_TYPE_TINY:
			if (unsig) return Poco::SQL::MetaColumn::FDT_UINT8;
			return Poco::SQL::MetaColumn::FDT_INT8;

		case MYSQL_TYPE_SHORT:
			if (unsig) return Poco::SQL::MetaColumn::FDT_UINT16;
			return Poco::SQL::MetaColumn::FDT_INT16;

		case MYSQL_TYPE_INT24:
		case MYSQL_TYPE_LONG:
			if (unsig) return Poco::SQL::MetaColumn::FDT_UINT32;
			return Poco::SQL::MetaColumn::FDT_INT32;

		case MYSQL_TYPE_FLOAT:
			return Poco::SQL::MetaColumn::FDT_FLOAT;

		case MYSQL_TYPE_DECIMAL:
		case MYSQL_TYPE_NEWDECIMAL:
		case MYSQL_TYPE_DOUBLE:
			return Poco::SQL::MetaColumn::FDT_DOUBLE;

		case MYSQL_TYPE_LONGLONG:
			if (unsig) return Poco::SQL::MetaColumn::FDT_UINT64;
			return Poco::SQL::MetaColumn::FDT_INT64;
			
		case MYSQL_TYPE_DATE:
			return Poco::SQL::MetaColumn::FDT_DATE;
		...
		case MYSQL_TYPE_STRING:
		case MYSQL_TYPE_VAR_STRING:
			return Poco::SQL::MetaColumn::FDT_STRING;

		case MYSQL_TYPE_TINY_BLOB:
		case MYSQL_TYPE_MEDIUM_BLOB:
		case MYSQL_TYPE_LONG_BLOB:
		case MYSQL_TYPE_BLOB:
			return Poco::SQL::MetaColumn::FDT_BLOB;
		default:
			return Poco::SQL::MetaColumn::FDT_UNKNOWN;
		}
	}
} // namespace
